...
public class GridLayout4Adapter extends DelegateAdapter.Adapter {
    private Context context;
    private GridLayoutHelper gridLayoutHelper4;
    private ArrayList<ShoppingBean.DataBean.HotGoodsListBean> hotGoodsListBeans;

    public GridLayout4Adapter(Context context, GridLayoutHelper gridLayoutHelper4, ArrayList<ShoppingBean.DataBean.HotGoodsListBean> hotGoodsListBeans) {
        this.context = context;
        this.gridLayoutHelper4 = gridLayoutHelper4;
